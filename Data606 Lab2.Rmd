...
#Set my working directory as C:\Users\Arnav\Documents\R\win-library\3.4\DATA606\labs\Lab2\more #
...
Answer: Streak length of 1 means one basket before missing the following basket. Streak length of 0 is when a miss follows another miss(second miss is 0 lenght streak)
...
Answer: Majority of all streaks are length 0.Kobe's longest streak was 4.The typical streak was of length 1.
...
```{r}
streak1 <- calc_streak(sim_basket)
```
...
The majority of shots were misses. The longest streak is of 4 baskets. The plot looks unimodal and left skewed. The mean is 0.942
...
Answer: Somewhat similar as shots are independent of each other.
...
The distributions of kobe's and simulated shooter are somewhat similar.
